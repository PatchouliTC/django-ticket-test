...
export const appRouters = [
  {
    ...
    component: LayOut,
    children: [
      {path: 'new', name: 'new', title: '新建申请', icon: 'mic-c', component: () => import('../components/ticket/New.vue'), meta: {isAdmin: false, hidden: false}},
      ...
      {path: 'all', name: 'all', title: '所有申请', icon: 'android-list', component: () => import('../components/ticket/All.vue'), meta: {isAdmin: true, hidden: true}},
      {path: 'todo/:id', name: 'todo-detail', title: '申请详情', component: () => import('../components/ticket/TicketDetail.vue')},
      {path: 'detail/:id', name: 'detail', title: '申请详情', icon: 'android-list', component: () => import('../components/ticket/TicketDetail.vue'), meta: {isAdmin: true, hidden: true}},
    ],
